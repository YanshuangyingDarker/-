...
CGContextRef XHCGContextCreateARGBBitmapContext(CGSize size, BOOL opaque, CGFloat scale);

/// Create a `DeviceGray` Bitmap context. Returns NULL if an error occurs.
CGContextRef XHCGContextCreateGrayBitmapContext(CGSize size, CGFloat scale);
 ...
 */
CGAffineTransform XHCGAffineTransformGetFromPoints(CGPoint before[3], CGPoint after[3]);

/// Get the transform which can converts a point from the coordinate system of a given view to another.
CGAffineTransform XHCGAffineTransformGetFromViews(UIView *from, UIView *to);
...
UIViewContentMode XHCAGravityToUIViewContentMode(NSString *gravity);

/// Convert UIViewContentMode to CALayer's gravity string.
NSString *XHUIViewContentModeToCAGravity(UIViewContentMode contentMode);
 ...
 */
CGRect XHCGRectFitWithContentMode(CGRect rect, CGSize size, UIViewContentMode mode);
...
// main screen's scale
#ifndef kScreenScale
#define kScreenScale XHScreenScale()
#endif

// main screen's size (portrait)
#ifndef kScreenSize
#define kScreenSize XHScreenSize()
#endif

// main screen's width (portrait)
#ifndef kScreenWidth
#define kScreenWidth XHScreenSize().width
#endif

// main screen's height (portrait)
#ifndef kScreenHeight
#define kScreenHeight XHScreenSize().height
#endif
