...
#import "UIApplication+XHAdd.h"
#import "NSObject+XHAdd.h"
#import "XHKitMacro.h"
...
XHSYNTH_DUMMY_CLASS(UIApplication_XHAdd)


#define kNetworkIndicatorDelay (1/30.0)
@interface _XHUIApplicationNetworkIndicatorInfo : NSObject
@property (nonatomic, assign) NSInteger count;
@property (nonatomic, strong) NSTimer *timer;
@end

@implementation _XHUIApplicationNetworkIndicatorInfo
@end


@implementation UIApplication (XHAdd)
...
XHSYNTH_DYNAMIC_PROPERXH_OBJECT(networkActivityInfo, setNetworkActivityInfo, RETAIN_NONATOMIC, _XHUIApplicationNetworkIndicatorInfo *);
...
- (void)_changeNetworkActivityCount:(NSInteger)delta {
    @synchronized(self){
        dispatch_async_on_main_queue(^{
            _XHUIApplicationNetworkIndicatorInfo *info = [self networkActivityInfo];
            if (!info) {
                info = [_XHUIApplicationNetworkIndicatorInfo new];
